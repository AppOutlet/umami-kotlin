...
data class Pixel(
     ...
     * This ID is used to reference the pixel in API calls.
     */
    @SerialName("id")
    val id: String,
    /**
     ...
     * This can be null if the pixel is not associated with a team.
     */
    @SerialName("teamId")
    val teamId: String?,
    /**
     ...
     * This will be null if the pixel has not been deleted.
     */
