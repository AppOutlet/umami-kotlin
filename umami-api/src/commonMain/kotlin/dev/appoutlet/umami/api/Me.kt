...
class Me(private val api: UmamiApi) {
     ...
     */
    suspend fun getSession(): Session = api.httpClient.get("me").body()

    /**
     * Retrieves a list of teams for the authenticated user.
     * @return A [SearchResponse] containing a list of [Team] objects.
     */
    suspend fun getTeams(): SearchResponse<Team> = api.httpClient.get("me/teams").body()
    ...
    suspend fun getWebsites(includeTeams: Boolean? = null): SearchResponse<Website> =
        api.httpClient.get("me/websites") {
