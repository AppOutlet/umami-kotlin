...
1) Run `./gradlew :umami:publishToMavenLocal`
2) Open `~/.m2/repository/dev/appoutlet/`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :umami:publishAndReleaseToMavenCentral --no-configuration-cache`
